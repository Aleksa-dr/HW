...
/*
 <input type = "text" class = "form" name = "operand" size = "5" />
        <input type = "text" name = "secondval" size = "10" /></p>
 */
...
<body>
<a href="calc1.php" style="color: black;">AAAAAAAAAAAAA</a><br>
<form method = "post" action="calc1.php">
    <p align = "center">
        <input type = "text" name = "firstval" size = "10" value="<?php if (isset($_GET["login"])) echo $_POST["firstval"] ?>" />

    <p align = "center"> <input type = "submit" name = "Посчитать" />
    </p>
</form>
</body>
</html>
